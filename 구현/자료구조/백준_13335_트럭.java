...
//                onLoad.add(new int[]{weight, 1});
                onLoad.add(new onload(weight, 1));
            }
        }
    ...
    static class onload{
        ...
        public onload(int weight, int distance){
            this.weight = weight;
